        ...
        json.forEach(function (item, i) {
            ...
            if (i < page_number) {
                ...
                tr.innerHTML = `
                            ...
                            <td>${item.time}</td>
                             <td>
            <a href="/browse/?corpus_name=${ item.name }" ><button type="button" class="btn btn-default " style="width: 150px;background-color:#DCDCDC">浏览查询</button>
            </a>
            <a href="/correct/?nid=${item.nid}&corpus_name=${ item.name }"><button type="button" class="btn btn-default " style="width: 160px;background-color:#DCDCDC">修改语料库名</button>
            </a>
            <a href="/delete_corpuses/?nid=${item.nid}&corpus_name=${ item.name }"><button type="button" class="btn btn-default " style="width: 150px;background-color:#DCDCDC">删除语料库</button>
            </a>
            <a href="/operate/?nid=${item.nid}&corpus_name=${ item.name }" class="window"><button type="button" class="btn btn-default " style="width: 150px;background-color:#DCDCDC">高级操作</button>
            <div class="w">
                <div class="panel panel-default">
                   <div class="panel-heading">
                   <h3 class="panel-title">高级操作</h3>
                   </div>
                <div class="panel-body">包括过滤、去重、规范化、分析评价、翻译评价、对齐这些操作</div>
                </div>
            </div>
            </a>
            </td>
